...
const projects: Project[] = [
  ...
  {
    title: "Landing Page ChainStrike",
    description: "Landing page para un proyecto de Blockchain llamado ChainStrike. Creado con Astro, Tailwind CSS, TypeScript y Framer Motion.",
    image: "/images/example6.webp",
    tags: ["Astro", "Tailwind CSS", "TypeScript", "Framer Motion"],
    github: "https://github.com/pipp3/landing-chainstrike",
    demo: "https://landing-chainstrike.vercel.app"
  },{
    title: "Manicero Lucas Showroom",
    description: "Showroom para un local de frutos secos llamado Manicero Lucas. Proyecto sigue en desarrollo.Creado con Astro, React, TypeScript, Tailwind CSS y Firebase.",
    image: "/images/example7.webp",
    tags: ["React","TypeScript","Tailwind CSS","Firebase"],
    demo: "https://manicero-lucas-showroom.vercel.app"
  },
  {
